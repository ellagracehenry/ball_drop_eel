cascade_size_time_nll <- function(par, model, data_clean, initator_responder, coefs, n_sims, fixed, n_time, time_tol) {
  ...
  model_result <- model(data_clean, initator_responder, par, coefs, n_sims, fixed, n_time, PRIVATE_ONLY)
...
social_private_model <- function(data_clean, initator_responder, params, coefs, n_sims, fixed, n_time, PRIVATE_ONLY) {
  ...
  fractional_contagion_subs <- TRUE #CHANGE HERE
